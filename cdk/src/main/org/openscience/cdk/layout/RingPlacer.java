...
public class RingPlacer 
{
	...
	static int SPIRO = 2;
        ...
        //Map contains pairs: ring size with start angle. 
	...
	public void placeRing(IRing ring, IAtomContainer sharedAtoms, Point2d sharedAtomsCenter, Vector2d ringCenterVector, double bondLength)
	{
        ...
        /**
         * Place ring with default start angles
         * @param ring
         * @param ringCenter
         * @param bondLength
         */
        ...
        /**
         * Place ring with provided angles 
         * @param ring
         * @param ringCenter
         * @param bondLength
         * @param angles
         */
	public void placeRing(IRing ring, Point2d ringCenter, double bondLength, Map<Integer,Double> angles ) {
        ...
        switch (ringSize) {
            case 3:
                    if (angles.get(3)!=null) 
                        startAngle=angles.get(3);
                    break;
            case 4:
                    if (angles.get(4)!=null)
                        startAngle=angles.get(4);
                    break;
            case 5:
                    if (angles.get(5)!=null)
                        startAngle=angles.get(5);
                    break;
            case 7:
                    if (angles.get(7)!=null)
                        startAngle=angles.get(7);
                    break;
            case 8:
                    if (angles.get(8)!=null)
                        startAngle=angles.get(8);
                    break;
        }
